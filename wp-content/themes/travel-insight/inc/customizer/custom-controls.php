 ...
 */
class Travel_Insight_Dropdown_Taxonomies_Control extends WP_Customize_Control {
...
class Travel_Insight_Customize_Horizontal_Line extends WP_Customize_Control {
	public $type = 'hr';
 ...
 * @see WP_Customize_Control
 */
class Travel_Insight_Dropdown_Category_Control extends WP_Customize_Control {
