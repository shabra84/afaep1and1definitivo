...
if ( ! function_exists( 'travel_insight_sanitize_select' ) ) :
	/**
	 ...
	 */
	function travel_insight_sanitize_select( $input, $setting ) {
...
if ( ! function_exists( 'travel_insight_sanitize_image' ) ) :
	/**
	 ...
	 */
	function travel_insight_sanitize_image( $image, $setting ) {
		/*
...
if ( ! function_exists( 'travel_insight_sanitize_number_range' ) ) :
	/**
	 ...
	 *                    the setting default.
	 */
	function travel_insight_sanitize_number_range( $number, $setting ) {
...
if ( ! function_exists( 'travel_insight_sanitize_page' ) ) :
	/**
	* Sanitizes page/post
	...
	* @since Travel Insight 0.1
	*/
	function travel_insight_sanitize_page( $input ) {
...
if ( ! function_exists( 'travel_insight_sanitize_checkbox' ) ) :
	/**
	 * Sanitize checkbox.
	 *
	 * @since Travel Insight 0.1
	 ...
	 */
	function travel_insight_sanitize_checkbox( $checked ) {
...
if ( ! function_exists( 'travel_insight_sanitize_category_list' ) ) :
	/**
	 ...
	 * @since Travel Insight 0.1
	 */
	function travel_insight_sanitize_category_list( $input ) {
		if ( $input != '' ) {
			$args = array(
							'type'			=> 'post',
							'child_of'      => 0,
...
if ( ! function_exists( 'travel_insight_santize_allow_tag' ) ) :
	/**
	 ...
	 */
	function travel_insight_santize_allow_tag( $input ) {
...
if( ! function_exists( 'travel_insight_sanitize_single_category' ) ) :
	/**
	 ...
	 * @since Travel Insight 0.1
	 */
	function travel_insight_sanitize_single_category( $input ) {
		if ( $input != '' ) {
			$args = array(
							'type'			=> 'post',
							'child_of'      => 0,
